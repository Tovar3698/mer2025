...
namespace Web.Controllers
{
    ...
    public class PermissionController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllPermission(PermissionBusiness _PermissionBusiness)
        {
            try
            {
        ...
        [ProducesResponseType(500)]
        public async Task<IActionResult> GetPermissionById(int id, object Permission)
        {
            try
            {
